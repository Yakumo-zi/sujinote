...
import com.suji.Alarm.AlarmReceiver;
import com.suji.Alarm.EditAlarmActivity;
import com.suji.Alarm.Plan;
import com.suji.Alarm.PlanAdapter;
import com.suji.Alarm.PlanDatabase;
...
public class MainActivity extends BaseActivity implements OnItemClickListener, OnItemLongClickListener {
    ...
    private FloatingActionButton fab_adv;
    private ListView lv;
...
//        preferences.edit().putBoolean(PRIVACY_POLICY_ACCEPTED, false).apply();
        ...
        fab_adv=findViewById(R.id.fab_adv);
        initView();
        ...
        fab_adv.setOnClickListener(view -> {
                            ...
                            new AlertDialog.Builder(MainActivity.this)
                                    ...
                                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            else Toast.makeText(context, "该标签已存在", Toast.LENGTH_SHORT).show();
                                        }
    ...
    private void refreshLvVisibility() {
        ...
        if(temp) myToolbar.setTitle("全部计划");
        else myToolbar.setTitle("全部记录");
    }
                ...
                if (view != null) {
                    view.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            ...
                            builder.setTitle("删除全部"+ itemName);
                            ...
                            builder.setItems(list_String, new DialogInterface.OnClickListener() {//列表对话框；
                                ...
                                public void onClick(DialogInterface dialog, final int which) {//根据这里which值，即可以指定是点击哪一个Item；
                                    new AlertDialog.Builder(MainActivity.this)
                                            .setMessage("你想删除所有 " + itemName + " " + list_String[which] + "？ ")
    ...
    public void refreshListView() {
        ...
        com.suji.Alarm.CRUD op1 = new com.suji.Alarm.CRUD(context);
        op1.open();
        if(planList.size() > 0) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (returnMode == 1) {  //update current note
            ...
            plan.setId(note_Id);
            com.suji.Alarm.CRUD op = new com.suji.Alarm.CRUD(context);
            op.open();
            op.updatePlan(plan);
            op.close();
    ...
    private void startAlarm(Plan p) {
        ...
        if(!c.before(Calendar.getInstance())) {
            ...
            PendingIntent pendingIntent = PendingIntent.getBroadcast(this, (int) p.getId(), intent, PendingIntent.FLAG_IMMUTABLE);
